...
local netcdf_c_ver=os.getenv("netcdf_c_ver") or "4.9.2b"
local netcdf_fortran_ver=os.getenv("netcdf_fortran_ver") or "4.6.1b"
...
local crtm_ver=os.getenv("crtm_ver") or "3.1.1-build1"
